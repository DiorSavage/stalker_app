...
class Base(DeclarativeBase):
	...
	@declared_attr
	def id(cls):
		return Column(Integer, primary_key=True, index=True, unique=True, autoincrement=True)
...
class Post(Base):
	...
	created_at: Mapped[datetime] = mapped_column(TIMESTAMP(timezone=True), server_default=func.timezone("utc", func.now()), default=datetime.now(timezone.utc))

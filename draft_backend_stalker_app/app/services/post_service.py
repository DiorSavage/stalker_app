...
from schemas.post_schema import PostCreateRequest, PostResponse,PostCommentCreateRequest
...
class IPostService:
	...
	@abstractmethod
	async def create_comment(self, comment_data: PostCommentCreateRequest, session: AsyncSession):
		pass
